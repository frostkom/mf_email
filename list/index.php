...
wp_enqueue_style('style_email_wp', plugins_url()."/mf_email/include/style_wp.css");
...
mf_enqueue_script('script_email_bb_plugins', plugins_url()."/mf_email/include/backbone/bb.plugins.js");
mf_enqueue_script('script_email_bb_router', plugins_url()."/mf_email/include/backbone/bb.router.js");
mf_enqueue_script('script_email_bb_models', plugins_url()."/mf_email/include/backbone/bb.models.js");
mf_enqueue_script('script_email_bb_views', plugins_url()."/mf_email/include/backbone/bb.views.js", array('emails2show' => EMAILS2SHOW));
...
echo "<div id='lost_connection'>".__("Lost Connection", 'lang_email')."</div>
<div id='saving'>".__("Saving", 'lang_email')."...</div>
<div id='loading'>".__("Loading", 'lang_email')."...</div>";
