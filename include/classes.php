...
class mf_email
{
	...
	function init_ungapped()
	{
		$this->ungapped_base_url = "https://api.ungapped.com";
	}
	...
	function get_ungapped_token($smtp_user, $smtp_pass)
	{
		...
		switch($headers['http_code'])
		{
			case 200:
				...
				$this->ungapped_access_token = $json['access_token'];
				//$bearer = $json['bearer'];
				//$expires_in = $json['expires_in'];

				$this->create_ungapped_message();
			break;

			default:
				do_log(__("I could not connect to Ungapped", 'lang_email')." (".var_export($headers, true).", ".$content.")");
			break;
		}
	}

	function create_ungapped_message()
	{
		$arr_post_data = array(
			'Subject' => $phpmailer->Subject,
			'FromName' => $phpmailer->FromName,
			'FromAddress' => $phpmailer->From,
			'BodyHTml' => $phpmailer->Body,
			'BodyText' => $phpmailer->AltBody,
		);
		...
		/*{
		  ...
		  "FromName": "string",
		  "FromAddress": "string",
		  "ScheduledForSending": "2018-08-12T05:41:27.925Z",
		  "StartedDateTime": "2018-08-12T05:41:27.925Z",
		  "EndedDateTime": "2018-08-12T05:41:27.925Z",
		  "EditableHtml": "string",
		  "EditableCss": "string",
		  "BodyHtml": "string",
		  "TestRecipients": "string",
		  "AutosavedCss": "string",
		  "AutosavedHtml": "string",
		  "Stylesheet": "string",
		  "Status": 0,
		  "Charset": "string",
		  "LastModified": "2018-08-12T05:41:27.925Z",
		  "LastModifiedBy": {
			...
			"Email": "string",
			"MobilePhone": "string",
			"Created": "2018-08-12T05:41:27.925Z",
			"Password": "string",
			"LanguageId": "string",
			"Language": {
			  "LanguageId": "string",
			...
			"LastNotificationRead": "2018-08-12T05:41:27.925Z",
			"Modified": "2018-08-12T05:41:27.925Z",
			"SmsNumber": "string",
			"Status": 0,
			"UserName": "string",
			"CreatedIssueCount": 0,
		  ...
		  "LastAutosaved": "2018-08-12T05:41:27.925Z",
		  "LastAutoSavedBy": {
			"UserId": "00000000-0000-0000-0000-000000000000",
			"FirstName": "string",
			"LastName": "string",
			"Email": "string",
			"MobilePhone": "string",
			"Created": "2018-08-12T05:41:27.926Z",
			"Password": "string",
			"LanguageId": "string",
			"Language": {
			  "LanguageId": "string",
			...
			"DefaultAccountId": "00000000-0000-0000-0000-000000000000",
			"LastNotificationRead": "2018-08-12T05:41:27.926Z",
			"Modified": "2018-08-12T05:41:27.926Z",
			"SmsNumber": "string",
			"Status": 0,
			"UserName": "string",
			"CreatedIssueCount": 0,
		  ...
		  "Lists": [
			{
			  ...
			  "IsDeleted": true,
			  "Created": "2018-08-12T05:41:27.926Z",
			  "LastModified": "2018-08-12T05:41:27.926Z",
			  "ContactCount": 0,
			  "ActiveImports": [
				{
				  ...
				  "Scheduled": "2018-08-12T05:41:27.926Z",
				  "Started": "2018-08-12T05:41:27.926Z",
				  "Ended": "2018-08-12T05:41:27.926Z",
				  "Data": "string",
				  "Frequency": 0,
				  "IsRecurring": true,
				  "LastRun": "2018-08-12T05:41:27.926Z",
				  "LastResult": "string",
				  "Recurrence": "string",
				  "RecurrenceCount": 0,
		  ...
		  "FromAddressIsValidated": true
		}*/

		list($content, $headers) = get_url_content(array(
			'url' => $this->ungapped_base_url."/Issues",
			'catch_head' => true,
			'post_data' => json_encode($arr_post_data),
		));
		...
		switch($headers['http_code'])
		{
			case 200:
				...
				do_log("Created Message: ".htmlspecialchars($content));

				//$this->ungapped_issue_id = $json[''];

				//$this->send_ungapped_message();
			break;
	...
	function send_ungapped_message()
	{
		$arr_post_data = array(
			'Contact' => array(
				'Email' => $phpmailer->getToAddresses(),
			),
		);
		...
		/*{
		  "Contact": {
			...
			"SourceName": "string",
			"SourceType": 0,
			"OptInDate": "2018-08-12T05:41:28.089Z",
			"HasBounced": true,
			"HasSmsBounced": true,
			"IsActive": true,
			"IsDeleted": true,
			"IsAnonymized": true,
			"IsSmsActive": true,
			"LastModified": "2018-08-12T05:41:28.090Z",
			"Created": "2018-08-12T05:41:28.090Z",
			"PhotoUrl": "string"
		  },
		  "IgnoreUnsubscribe": true,
		  "Expires": "2018-08-12T05:41:28.090Z",
		  "RecipientData": {},
		  "CountryCode": "string",
		...
		list($content, $headers) = get_url_content(array(
			'url' => $this->ungapped_base_url."/Issues/".$this->ungapped_issue_id."/SendTransactional",
			'catch_head' => true,
			'post_data' => json_encode($arr_post_data),
		));
		...
		switch($headers['http_code'])
		{
			case 200:
				...
				do_log("Sent Message: ".htmlspecialchars($content));
			break;
	...
	function phpmailer_init($phpmailer)
	{
		...
		switch($outgoing_type)
		{
			...
			case 'ungapped':
				...
				$this->get_ungapped_token($smtp_user, $smtp_pass);

				$phpmailer->ClearAllRecipients();
				//throw new \phpmailerException(__("Too many emails sent!", 'lang_email'));
				//my_condition() == false and $phpmailer = new stdClass;
			break;
		}
	}
