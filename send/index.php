				...
				<div id='post-body-content'>
					<div class='postbox'>
						...
						<div class='inside'>"
							...
							.show_textfield(array('name' => 'strMessageSubject', 'text' => __("Subject", 'lang_email'), 'value' => $obj_email->message_subject, 'required' => 1))
				...
				<div id='postbox-container-1'>
					...
					<div class='postbox'>
						...
						<div class='inside'>";
							...
							echo show_select(array('data' => $arr_data_source, 'name' => 'intEmailTextSource', 'text' => __("Text Source", 'lang_email'), 'xtra' => "rel='submit_change' disabled"))
